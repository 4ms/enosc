...
static_assert((10_u).to_float().repr() == 10.f, "");
static_assert((12495_u).to_float() == 12495_f, "");
...
static_assert((-0.5_s1_15).to_float() == -0.5_f, "");
static_assert((-0.125_s1_15 - 0.5_s1_15).to_float() == -0.625_f, "");
...
static_assert((0.5_u0_16 + 0.125_u0_16).to_float() == 0.625_f, "");
static_assert((0.25_u0_16 - 0.125_u0_16).to_float() == 0.125_f, "");
static_assert((0.25_u0_16 - 0.5_u0_16).to_float() == 0.75_f, "");

// TODO: constexpr problem with this one:
// static_assert(-1.0_s1_31 == 1.0_s1_31, "");

static_assert((0.45_u0_32).to_float() == 0.45_f, "");
static_assert(0.5_u0_32 == 0.5_u0_32, "");
static_assert((0.345_u0_32).to_float() == 0.345_f, "");
static_assert(1.0_u0_32 == 0.0_u0_32, "");
static_assert(0.625_u0_32 + 0.125_u0_32 == 0.75_u0_32, "");
static_assert((-0.5_s1_31).to_float() == -0.5_f, "");
static_assert((-0.5_s1_31+0.75_s1_31).to_float() == 0.25_f, "");
